...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("id", "salon"), name="booking_appointment_id_salon_uniq"
                    ),
        ...
        composite_tenant_fk(
            child_table="booking_appointment",
            fk_column="customer_id",
            parent_table="accounts_customer",
            constraint_name="booking_appointment_customer_composite_fk",
        ),
        composite_tenant_fk(
            child_table="booking_appointment",
            fk_column="specialist_id",
            parent_table="specialists_specialist",
            constraint_name="booking_appointment_specialist_composite_fk",
        ),
        composite_tenant_fk(
            child_table="booking_appointment",
            fk_column="service_id",
            parent_table="catalog_service",
            constraint_name="booking_appointment_service_composite_fk",
        ),
    ]
